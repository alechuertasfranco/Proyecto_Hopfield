           ...
           <div class="form-content">
                <form>
                    <div class="form-group">
                        <input id="username" type="text" name="username" required="required" placeholder="Usuario"/>
                    </div>
                    <div class="form-group">
                        <input id="password" type="password" name="password" required="required" placeholder="Contraseña"/>
                    </div>
                    <div class="form-group">
                        <input id="nombres" type="nombres" name="nombres" required="required" placeholder="Nombres y Apellidos"/>
                    </div>
                    <div class="form-group">
